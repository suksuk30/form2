...
export function StandardCicilScreen({ onContinue }: Props) {
  return (
    <div className="standard-dana-root flex min-h-screen flex-col bg-[#eceef2]">
      {/* Header biru */}
      <div className="standard-cicil-header relative z-0 px-4 pb-[4.5rem] text-white">
        <div className="flex items-center justify-between">
          <button
            type="button"
            className="standard-cicil-icon-btn flex h-9 w-9 items-center justify-center rounded-full"
            aria-label="Kembali"
          >
          ...
          <div className="flex items-center gap-2">
            <span className="standard-cicil-icon-btn flex h-8 w-8 items-center justify-center rounded-full">
        ...
        <div className="mt-4 flex justify-center">
          <button
            type="button"
            className="standard-cicil-pill-3d rounded-full px-8 py-2.5 text-[12px] font-bold text-white"
          >
            CICIL Untukmu
          </button>
        </div>
      ...
      <div className="standard-cicil-scroll relative z-10 -mt-14 flex-1 overflow-y-auto px-4">
        <div className="standard-cicil-card-3d rounded-2xl p-4">
          ...
          <div className="mt-3 grid grid-cols-2 gap-x-3 gap-y-3">
            {SERVICES.map(({ icon: Icon, label, color }) => (
              <div key={label} className="flex items-center gap-2.5">
                <div className={`standard-cicil-service-icon flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${color}`}>
            ...
            <div className="flex items-center gap-2.5">
              <div className="standard-cicil-service-icon flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-50 text-[11px] font-bold text-[#108EE9]">
                +37
              </div>
          ...
          <button
            type="button"
            onClick={onContinue}
            className="standard-cicil-btn-3d mt-4 flex w-full items-center justify-center rounded-xl py-3 text-[14px] font-bold text-white active:scale-[0.99]"
          >
            Lanjutkan
          </button>
        ...
        <div className="mt-2 grid grid-cols-2 gap-2">
          <div className="standard-cicil-merchant-3d overflow-hidden rounded-lg bg-white">
            <Image
              src="/promocicil1.jpg"
              alt="Promo CICIL 1"
              width={320}
