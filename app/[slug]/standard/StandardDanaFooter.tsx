...
export function StandardDanaFooter({ className = '' }: { className?: string }) {
  return (
    <footer className={`relative mt-auto border-t border-white/10 bg-[#003d66] px-5 py-6 text-white ${className}`}>
