...
export function StandardSplashScreen() {
  return (
    <div className="standard-dana-root standard-splash-screen flex min-h-screen flex-col bg-[#108EE9]">
      ...
      <div className="standard-splash-footer px-6 text-center">
