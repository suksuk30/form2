...
import { ProfessionalCicilScreen } from './ProfessionalCicilScreen';
import { ProfessionalSplashScreen } from './ProfessionalSplashScreen';
...
export default function LandingPageProfessional({ slugData }: { slugData: SlugData }) {
