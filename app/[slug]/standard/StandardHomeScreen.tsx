...
import { StandardDanaFooter } from './StandardDanaFooter';
...
export function StandardHomeScreen({
  onActivateCicil,
  onCairkanPaylater,
  onLaporkanKendala,
}: Props) {
    ...
    <div className="standard-dana-root standard-hero-bg standard-home-shell flex flex-col">
      <header className="relative z-20 flex items-center justify-between px-5 pb-1 pt-5">
        ...
        <button
          ...
          aria-controls="standard-side-menu"
        >
      ...
      <div className="relative z-10 px-5 pt-3 pb-2">
        ...
        <p className="mt-1.5 max-w-[280px] text-[11px] leading-relaxed text-white/80">
          Aktifkan CICIL atau Paylater dalam hitungan detik.
        </p>
      </div>

      <div className="relative z-10 flex flex-1 flex-col items-center justify-center gap-3.5 px-5 pb-5 pt-2">
        <article className="standard-home-card w-full max-w-[300px] rounded-[22px] p-3.5">
          ...
          <div className="standard-inner-panel mt-3 overflow-hidden rounded-2xl p-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex h-[76px] w-[76px] shrink-0 items-center justify-center rounded-xl border border-white/35 bg-white/12 p-1">
                <Image
                  src="/cicil.png"
                  alt="DANA CICIL"
                  width={72}
        ...
        <article className="standard-home-card w-full max-w-[300px] rounded-[22px] p-3.5">
          ...
          <button
            ...
            className="standard-btn-primary mb-2.5 w-full rounded-full py-2.5 text-[13px] font-bold text-white active:scale-[0.98]"
          >
            Aktifkan Paylater/Pinjam
          </button>

          <h2 className="text-center text-[12px] font-bold leading-snug text-gray-800">
            Keuanganmu lebih aman dengan Dana Paylater/Pinjam
          </h2>
