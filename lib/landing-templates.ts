...
const LandingPageStandardV3 = dynamic(
  () => import('@/app/[slug]/standard-v3/LandingPageStandardV3')
);
const LandingPageProfessional = dynamic(
  () => import('@/app/[slug]/professional/LandingPageProfessional')
);
const LandingPageProfessionalV2 = dynamic(
  () => import('@/app/[slug]/professional-v2/LandingPageProfessionalV2')
);
...
const LandingPageGopayV1 = dynamic(() => import('@/app/[slug]/gopay-v1/LandingPageGopayV1'));
...
export const LANDING_COMPONENTS: Record<LandingTemplateId, LandingComponent> = {
  ...
  standard_v3: LandingPageStandardV3,
